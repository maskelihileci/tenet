    ...
    def _process_line(self, line, relative_idx):
        ...
        for item in delta:
            ...
            # handle memory r/w/rw access
                ...
                #
                # a single line can contain multiple memory entries of the same
                # type. they will be delimited by a ';'
                #
                #    eg: mr=ADDRESS:DATA;ADDRESS:DATA;...
                #

                for entry in value.split(';'):
                    address, hex_data = entry.split(":")
